...
- **Social links** — Instagram, Facebook, and TikTok all point to `detailvalleyid`.
  Make sure each account actually exists and has a post or two before promoting it.
